...
contract Avatheeers is IERC721, ERC165 {
	...
	event NewAvatheeerCreated(string name, address owner);
    // event Approval(address owner, address user, uint256 id);
    // event Transfer(address owner, address user, uint256 id);
    ...
    function createRandomAvatheeer(string memory _name) public {
        ...
        emit NewAvatheeerCreated(_name, msg.sender);
    }
        ...
        isUnique(_dna)
    {
        ...
        ownerAvatheeerCount[msg.sender] = ownerAvatheeerCount[msg.sender].add(1);
    }
